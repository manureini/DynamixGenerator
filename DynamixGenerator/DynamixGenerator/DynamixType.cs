...
namespace DynamixGenerator
{
    public class DynamixType : Type
    {
        ...
        public override string FullName => mNamespace + "." + mName;

        public override Guid GUID => mGuId;

        public override Module Module => typeof(DynamixType).Module;

        public override string Namespace => mNamespace;

        public override Type UnderlyingSystemType => typeof(DynamixType);

        public override string Name => mName;

        public DynamixType(Guid pGuid, string pNamespace, string pName)
        {
            mGuId = pGuid;
